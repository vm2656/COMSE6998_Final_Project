...
model = load_model('trainedmodel_15class.hdf5',compile=False)
...
preds = predictions(fpath,preds, top=1)
...
for label in labels.keys():
	...
	selected_indices = tf.image.non_max_suppression(boxes, proba,3)
